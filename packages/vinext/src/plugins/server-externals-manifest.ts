...
import { packageNameFromNodeModulesPath, packageNameFromSpecifier } from "../utils/package-name.js";

export { packageNameFromNodeModulesPath, packageNameFromSpecifier };
